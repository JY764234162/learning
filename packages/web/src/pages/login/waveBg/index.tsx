...
const WaveBg = memo(() => {
  return (
    <div className="absolute left-0 top-0 z-[1] h-full w-full overflow-hidden">
      <div className="absolute -right-[100px] -top-[1170px] sm:-right-[300px] sm:-top-[900px]">
        <svg height="1337" width="1337">
          <defs>
            ...
            <linearGradient id="linearGradient-2" x1="0.79" x2="0.21" y1="0.62" y2="0.86">
              <stop offset="0" stopColor={"var(--ant-color-primary-border)"} stopOpacity="1" />
              <stop offset="1" stopColor={"var(--ant-color-primary-border)"} stopOpacity="1" />
            </linearGradient>
          </defs>
          <g opacity="1">
